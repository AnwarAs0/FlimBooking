	...
	public String bookSeat(@ModelAttribute("Seat") Seat seat, @RequestParam("movieName") String movieName,
		...
		if (object == null) {
			...
			if (((date.isAfter(currentDate)) || (date.equals(currentDate)))
				...
				session.setAttribute("msg", "your seat booked and mail confirmation send successsfully");
				
				String seatNumbers = String.join(", ", seat.getSeatNo());
			    String formattedSeatNumbers = "Booked seat numbers " + seatNumbers;
				
				String toEmail = object.getEmail(); // Assuming Customer object has getEmail() method
			    String subject = "Booking Confirmation";
			    String body = "Your seat has been booked successfully for the movie: " + movieName+" and "+formattedSeatNumbers +",  $"+ seat.getTotal()+" Amount Received";

			    mail.sendSimpleEmail(toEmail, subject, body);
